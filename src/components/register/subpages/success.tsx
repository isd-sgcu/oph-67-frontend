    ...
    <div className='relative flex h-screen w-full flex-col items-center justify-center bg-[#FAE9F3]'>
      ...
      <div className='relative z-10 flex flex-col items-center justify-center gap-5'>
        <Image
          ...
          width={220}
        />
        <div className='flex flex-col items-center justify-center gap-0 font-cloud-soft text-sm font-normal tracking-tight text-[#064E41]'>
          <div className='text-2xl font-bold'>ลงทะเบียนเรียบร้อย!</div>
